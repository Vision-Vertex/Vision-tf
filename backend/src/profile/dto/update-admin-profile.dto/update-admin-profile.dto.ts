...
export class NotificationSettingsDto {
  ...
  @ApiPropertyOptional({
    description: 'Security alerts enabled',
    example: true,
  })
  @IsBoolean()
  @IsOptional()
...
export class AdminProfileDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'System administrator with full access rights',
  })
  @IsString()
  @IsOptional()
  bio?: string;
  ...
  @ApiPropertyOptional({
    description: 'Chat last read timestamp',
    example: '2025-08-10T15:30:00Z',
  })
  @IsDateString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    example: { available: true, timezone: 'UTC+3' },
  })
  @IsOptional()
  availability?: any;
  ...
  @ApiPropertyOptional({
    ...
    example: { degree: 'BS Computer Science', university: 'MIT' },
  })
  @IsOptional()
  education?: any;

  @ApiPropertyOptional({ description: 'Hourly rate', example: 75.5 })
  @IsNumber()
  @IsOptional()
  hourlyRate?: number;
  ...
  @ApiPropertyOptional({
    description: 'Permissions list',
    example: ['manage_users', 'edit_content', 'view_analytics'],
  })
  @IsArray()
  @IsOptional()
  permissions?: string[];
  ...
  @ApiPropertyOptional({
    ...
    example: { projectTypes: ['web', 'mobile'], duration: '3-6 months' },
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    example: { remoteWork: true, travelWillingness: 'low' },
  })
  @IsOptional()
  workPreferences?: any;
  ...
  @ApiPropertyOptional({
    ...
    example: ['https://portfolio.com', 'https://behance.net/johndoe'],
  })
  @IsOptional()
  portfolioLinks?: any;
...
export class ProfileFiltersDto {
  ...
  @ApiPropertyOptional({
    description: 'Filter by multiple permissions',
    example: ['manage_users', 'edit_content'],
  })
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    description: 'Filter by last system access (from)',
    example: '2025-01-01T00:00:00Z',
  })
  @IsDateString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Filter by last system access (to)',
    example: '2025-12-31T23:59:59Z',
  })
  @IsDateString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Filter by skills (for developers)',
  ...
  @ApiPropertyOptional({
    description: 'Filter by minimum experience years (for developers)',
    example: 3,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Filter by maximum experience years (for developers)',
    example: 10,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Filter by availability status (for developers)',
    example: true,
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Filter by remote work preference (for developers)',
    example: true,
  })
  @IsBoolean()
  @IsOptional()
...
export class RoleStatisticsDto {
  ...
  @ApiPropertyOptional({
    description: 'Total count for this role',
    example: 150,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Active count for this role',
    example: 120,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Verified email count for this role',
    example: 100,
  })
  @IsNumber()
  @IsOptional()
...
export class TimeSeriesDataDto {
  ...
  @ApiPropertyOptional({
    description: 'Role-specific count',
    example: { [UserRole.DEVELOPER]: 15, [UserRole.CLIENT]: 10 },
  })
  @IsOptional()
...
export class SkillStatisticsDto {
  ...
  @ApiPropertyOptional({
    description: 'Number of developers with this skill',
    example: 45,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Percentage of developers with this skill',
    example: 30.0,
  })
  @IsNumber()
  @IsOptional()
...
export class ActivityStatisticsDto {
  ...
  @ApiPropertyOptional({
    description: 'Users active in last 90 days',
    example: 200,
  })
  @IsNumber()
  @IsOptional()
...
export class ProfileStatisticsDto {
  ...
  @ApiPropertyOptional({
    description: 'Total number of active profiles',
    example: 200,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Total number of verified profiles',
    example: 180,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Statistics by user role',
    type: [RoleStatisticsDto],
  })
  @IsArray()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Registration trend over time',
  ...
  @ApiPropertyOptional({
    description: 'Top skills among developers',
    type: [SkillStatisticsDto],
  })
  @IsArray()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Geographic distribution by timezone',
    type: [GeographicStatisticsDto],
  })
  @IsArray()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Average profile completion rate',
    example: 85.5,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Profiles created this month',
    example: 25,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Profiles updated this month',
    example: 45,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Growth rate compared to last month (percentage)',
    example: 15.5,
  })
  @IsNumber()
  @IsOptional()
